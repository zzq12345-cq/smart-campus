<template>
  <view :class="['life-publish-page', themeClass]">
    <view class="top-bar">
    ...
    <view class="hero-card">
      ...
      <view class="hero-icon">
        <Icon name="self_improvement" :size="132" color="rgba(244, 157, 37, 0.22)" />
      </view>
    </view>
    ...
    <view class="composer-card">
      <view class="composer-header">
        <view class="composer-icon">
          <Icon name="edit_square" :size="20" color="#f49d25" />
        </view>
      ...
      <view class="composer-row">
        <view class="switch-wrap">
          ...
          <switch :checked="isAnonymous" color="#f49d25" @change="onAnonymousSwitch" />
        </view>
...
const draftTopic = ref<LifeTopic>('life_help')
...
const topicOptions = computed(() => [
  { value: 'life_help' as LifeTopic, label: isZh.value ? '生活互助' : 'Life Help' },
...
onShow(async () => {
  ...
  if (!requireAuth('/pages/life/post-publish')) {
    return
  }
